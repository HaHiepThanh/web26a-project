...
-- =============================================================================
-- SEED DỮ LIỆU TEST — DÀNH RIÊNG CHO HOÀ
-- =============================================================================
...
--
-- ✅ FILE NÀY DÀNH RIÊNG CHO HOÀ — KHÔNG CẦN SỬA GÌ, dán vào là chạy.
--
...
do $$
declare
  -- email test của Hoà — đã điền sẵn, đừng đổi
  my_email  text := 'hocvien-b@test.dev';
