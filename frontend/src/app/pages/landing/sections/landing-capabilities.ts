  ...
  readonly groups = [
    ...
    },
    {
      ...
      items: [
        ...
        'Schedule a meeting on the board, with guests and a time zone',
        'Meetings repeat, and remind you before they start',
        'Each one lands in Google Calendar, with a Meet room if you want',
        'Import or export .ics, and print the agenda as a PDF',
    ...
    },
    {
      ...
      items: [
        ...
        'Deleting a list, workspace or organization asks first',
